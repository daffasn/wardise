          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ url('testimoni/tambah') }}" class="btn btn-success" style="width: 100%;"><i class="fas fa-plus"></i> Tambah</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="{{ url('testimoni/edit/'.$item->id) }}" class="btn btn-info"><i class="fas fa-pencil-alt"></i></a>
                    <form action="{{ url('testimoni/' .$item->id)}}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                    @method('delete')
                    @csrf
